...
<?php
    ...
    function getlolacounts(){
        ...
        $number = 0;
        //Prepared statement
        $stmt = $conn->prepare("SELECT SummonerName, Zone, lolrank.Name AS rankName, lolrank.rankID AS rankNr, lolrole1.Name AS role1, lolrole2.Name AS role2, Level, Bio
